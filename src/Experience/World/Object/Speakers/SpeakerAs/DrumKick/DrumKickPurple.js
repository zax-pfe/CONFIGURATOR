...
export default class DrumKickPurple {
  constructor() {
    // setupt the experience - get the sounds and resources
    this.experience = new Experience();
    this.resource = this.experience.resources.items.DrumKickPurple;
  ...
  setup() {
    ...
    this.music = this.experience.soundManager.soundLibrary.violet.violet5;
  }
